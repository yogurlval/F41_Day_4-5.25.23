...
let newFruits = fruits.forEach((str, index) => {
  if(str.color === `red`){
   console.log(`The fruit with the index ${index} is an apple`)
 } else if (str.color === `orange`){
   console.log(`The fruit with the index ${index} is an orange`)
 } else {
   console.log(`The fruit with the index ${index} is neither an apple or Orange`)
 }
...
// The fruit with the index 0 is neither an apple or Orange
// The fruit with the index 1 is an orange
// The fruit with the index 2 is neither an apple or Orange
...
let foodTotal = foods.filter((obj) =>{
  return obj.tags.includes("rice")
}).reduce((acc, curr)=>{
