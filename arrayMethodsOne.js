...
let totalPrice = orders.map((obj)=>{
  return (obj.tax * obj.price) +obj.price
})

console.log(totalPrice)

// const orderSum = arr => {
//   const priceTotal = arr.map(obj => (obj.price * obj.tax) + obj.price)
//   return priceTotal
// }
...
const bobsTotal = purchases.filter((obj) =>{
  return obj.owner.includes("Bob")
}).reduce((acc, curr) =>{
